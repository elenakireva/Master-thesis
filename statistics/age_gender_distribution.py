# Name: Elena Kireva
# Description: This Python script takes .txt files with age/gender information
...
# Extract ages and convert them to integers, ignoring lines that don't contain age data
# For control group
ages_control = []
...
# Calculate the average age (control group)
if ages_control:
    average_age_control = sum(ages_control) / len(ages_control)
    print("Average age for control:", average_age_control)
else:
    print("No valid age data found in the file.")

# Calculate the average age (dementia group)
if ages_dementia:
